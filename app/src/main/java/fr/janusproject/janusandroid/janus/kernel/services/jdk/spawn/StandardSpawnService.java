 ...
 */
package fr.janusproject.janusandroid.janus.kernel.services.jdk.spawn;

import fr.janusproject.janusandroid.janus.kernel.bic.BuiltinCapacityUtil;
...
import fr.janusproject.janusandroid.janus.services.spawn.AgentFactory;
import fr.janusproject.janusandroid.janus.services.spawn.KernelAgentSpawnListener;
import fr.janusproject.janusandroid.janus.services.spawn.SpawnService;
import fr.janusproject.janusandroid.janus.services.spawn.SpawnServiceListener;
...
public class StandardSpawnService extends AbstractDependentService implements SpawnService {
	...
	protected void fireAgentSpawned(AgentContext context, Agent agent, Object[] initializationParameters) {
		...
		// fr.janusproject.janusandroid.janus.kernel.bic.StandardBuiltinCapacitiesProvider
		// is invoked.
