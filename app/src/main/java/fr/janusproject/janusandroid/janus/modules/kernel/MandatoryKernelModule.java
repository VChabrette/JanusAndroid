...
import fr.janusproject.janusandroid.janus.kernel.bic.StandardBuiltinCapacitiesProvider;
import fr.janusproject.janusandroid.janus.kernel.space.EventSpaceSpecificationImpl;
import fr.janusproject.janusandroid.janus.kernel.space.OpenEventSpaceSpecificationImpl;
import fr.janusproject.janusandroid.janus.kernel.space.RestrictedAccessEventSpaceSpecificationImpl;
import fr.janusproject.janusandroid.janus.services.GoogleServiceManager;
import fr.janusproject.janusandroid.janus.services.IServiceManager;
...
public class MandatoryKernelModule extends AbstractModule {
	...
	@Provides
	@fr.janusproject.janusandroid.janus.kernel.annotations.Kernel
	@Singleton
