 ...
 */
package fr.janusproject.janusandroid.janus.kernel.bic;

import fr.janusproject.janusandroid.janus.services.executor.ChuckNorrisException;
...
class LifecycleSkill extends Skill implements Lifecycle {
	...
	public static class AgentKillException extends RuntimeException {
		 ...
		 * @param e - cause
		 */
		AgentKillException(fr.janusproject.janusandroid.janus.services.spawn.SpawnService.AgentKillException e) {
		...
		public UUID getAgent() {
			return ((fr.janusproject.janusandroid.janus.services.spawn.SpawnService.AgentKillException) getCause()).getAgent();
		}
